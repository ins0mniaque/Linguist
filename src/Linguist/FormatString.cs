...
namespace Linguist
{
    ...
    public sealed class FormatString
    {
        ...
        /// <summary>
        /// Initializes a new preparsed instance of the <see cref="T:Linguist.FormatString" /> class
        /// with the argument holes specified as a <see cref="T:Linguist.FormatString.ArgumentHole" /> array.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new preparsed parameterized instance of the <see cref="T:Linguist.FormatString" /> class
        /// with the argument holes specified as a <see cref="T:Linguist.FormatString.ArgumentHole" /> array and
        /// argument parameters as a <see cref="T:Linguist.FormatString.Argument" /> array.
        /// </summary>
        /// <param name="format">The preparsed format string.</param>
        /// <param name="argumentHoles">The argument holes array value of the preparsed format string.</param>
        ...
        /// <summary>Gets or sets the arguments parameters for the current <see cref="T:Linguist.FormatString" /> object.</summary>
        ...
        /// <summary>Gets the parsed argument holes for the current <see cref="T:Linguist.FormatString" /> object.</summary>
        ...
        {
            /// <summary>
            /// Initializes a new instance of the <see cref="T:Linguist.FormatString.Argument" /> class
            ...
            /// <summary>Gets or sets the argument hole used for number formatting for the current <see cref="T:Linguist.FormatString.Argument" /> object.</summary>
            /// <returns>The argument hole used for number formatting.</returns>
            public ArgumentHole NumberArgumentHole { get; set; }

            /// <summary>Gets or sets the number form for the current <see cref="T:Linguist.FormatString.Argument" /> object.</summary>
            /// <returns>The number form.</returns>
            public NumberForm NumberForm { get; set; }

            /// <summary>Gets or sets the available plural forms for the current <see cref="T:Linguist.FormatString.Argument" /> object.</summary>
            /// <returns>The available plural forms.</returns>
            public PluralForm AvailablePluralForms { get; set; }

            /// <summary>Gets or sets the plural range form for the current <see cref="T:Linguist.FormatString.Argument" /> object, or null if not a range argument.</summary>
            /// <returns>The plural range form, or null if not a range argument.</returns>
            public PluralForm? PluralRangeForm { get; set; }

            /// <summary>Converts the value of the current <see cref="T:Linguist.FormatString.Argument" /> object to its equivalent string representation.</summary>
        ...
        public sealed class ArgumentHole
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="T:Linguist.FormatString.ArgumentHole" /> class
            ...
            /// <summary>Gets the argument hole index for the current <see cref="T:Linguist.FormatString.ArgumentHole" /> object.</summary>
            /// <returns>The argument hole index.</returns>
            public int Index { get; }

            /// <summary>Gets the optional alignment parameter for the current <see cref="T:Linguist.FormatString.ArgumentHole" /> object.</summary>
            /// <returns>The optional alignment parameter.</returns>
            public int Alignment { get; }

            /// <summary>Gets the optional formatting parameter for the current <see cref="T:Linguist.FormatString.ArgumentHole" /> object.</summary>
            /// <returns>The optional formatting parameter.</returns>
            public string Format { get; }

            /// <summary>Gets the start offset in the format string for the current <see cref="T:Linguist.FormatString.ArgumentHole" /> object.</summary>
            /// <returns>The start offset in the format string.</returns>
            public int Start { get; }

            /// <summary>Gets the end offset in the format string for the current <see cref="T:Linguist.FormatString.ArgumentHole" /> object.</summary>
            /// <returns>The end offset in the format string.</returns>
            public int End { get; }

            /// <summary>Gets a value indicating whether the current <see cref="T:Linguist.FormatString.ArgumentHole" /> object has a non-zero alignment.</summary>
            /// <returns><see langword="true" /> if the current <see cref="T:Linguist.FormatString.ArgumentHole" /> object has a non-zero alignment; <see langword="false" /> otherwise.</returns>
            public bool HasAlignment => Alignment != 0;

            /// <summary>Gets a value indicating whether the current <see cref="T:Linguist.FormatString.ArgumentHole" /> object has a format.</summary>
            /// <returns><see langword="true" /> if the current <see cref="T:Linguist.FormatString.ArgumentHole" /> object has a format; <see langword="false" /> otherwise.</returns>
            public bool HasFormat => ! string.IsNullOrEmpty ( Format );

            /// <summary>Converts the value of the current <see cref="T:Linguist.FormatString.ArgumentHole" /> object to its equivalent format string representation.</summary>
            ...
            /// <summary>Converts the value of the current <see cref="T:Linguist.FormatString.ArgumentHole" /> object to its equivalent format string representation with the offset range appended, formatted as "@[start..end]".</summary>
            /// <returns>
        ...
        /// <param name="formatString">The equivalent <see cref="T:Linguist.FormatString" /> instance of the format string.</param>
        ...
        /// <summary>Converts a format string to an equivalent <see cref="T:Linguist.FormatString" /> instance.</summary>
        /// <param name="format">A format string to convert.</param>
        /// <returns>An equivalent <see cref="T:Linguist.FormatString" /> instance.</returns>
